...
seed = 12345
noise = ops.random.normal((512 // 8, 512 // 8, 4), seed=seed)
...
walk_noise_x = ops.random.normal(noise.shape, dtype="float64")
walk_noise_y = ops.random.normal(noise.shape, dtype="float64")
